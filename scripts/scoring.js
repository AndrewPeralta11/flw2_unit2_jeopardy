...
function subtractFromScore() {
  // Add code here
  let scoreS = getCurrentScore();
  scoreS = scoreS - currentQuestionValue;
  $("#current-score").text(scoreS);
}

function addToScore() {
  // Add code here
  let scoreA = getCurrentScore();
  scoreA = scoreA + currentQuestionValue;
  $("#current-score").text(scoreA);
}
